...
async def on_ready():
    ...
    await bot.add_cog(cogs.arx_games.ArxGames(bot, EMBED_COLOR))
    await bot.add_cog(cogs.arx_games.ArxScramble(bot, EMBED_COLOR))
    await bot.add_cog(cogs.arx_games.ArxFastClick(bot))
    await bot.add_cog(cogs.arx_utils.ArxUtils(bot, EMBED_COLOR))
    await bot.add_cog(cogs.arx_fun.ArxFun(bot, EMBED_COLOR))
    await bot.add_cog(cogs.arx_owner.ArxUpdate(bot, EMBED_COLOR))
    await bot.add_cog(cogs.arx_uwu.ArxUwU(bot))
    await bot.add_cog(cogs.arx_cah.ArxCAH(bot, EMBED_COLOR))
    await bot.add_cog(cogs.arx_minesweeper.ArxMinesweeper(bot))
    await bot.add_cog(cogs.arx_quote.ArxQuotes(bot))
    await bot.add_cog(cogs.arx_meme.ArxMemes(bot, EMBED_COLOR))
    await bot.add_cog(cogs.arx_levels.ArxLevels(bot, EMBED_COLOR))
    ...
    await bot.add_cog(cogs.arx_mod.Moderation(bot))
